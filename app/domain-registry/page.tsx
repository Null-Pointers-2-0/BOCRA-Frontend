  ...
  return (
    <>
      ...
      <main className="min-h-screen flex flex-col px-6">
        {/* ── Hero Section ── */}
        <div className="flex flex-col items-center text-center space-y-4 mt-20 md:mt-30 mb-12">
          <h1 className="text-4xl font-bold">
            .bw Domain Registry
          </h1>
          <p className="text-gray-600 max-w-2xl text-lg">
            Check if your desired .bw domain name is available for registration.
          </p>
        </div>

        {/* ── Domain Availability Check ── */}
        <section className="w-full max-w-3xl mx-auto space-y-6 mb-16">
          <h2 className="text-2xl font-semibold">Check Domain Availability</h2>
          ...
          {availability && (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xl font-bold">{availability.domain_name}</p>
                  <p
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {whoisResult.registered_at
                      ? new Date(whoisResult.registered_at).toLocaleDateString(
                          "en-BW",
